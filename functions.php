...
function pm_enqueue_scripts() {
    ...
    wp_register_script(
        'transition',
        '//mondial.palimg.com/wp-content/themes/petitmondial/js/vendor/Bootstrap/bootstrap-transition.js',
        array('jquery'),
        false,
        true
    );
    ...
    wp_register_script(
        'carousel',
        '//mondial.palimg.com/wp-content/themes/petitmondial/js/vendor/Bootstrap/bootstrap-carousel.js',
        array('jquery'),
        false,
        true
    );
    ...
    wp_register_script(
        'collapse',
        '//mondial.palimg.com/wp-content/themes/petitmondial/js/vendor/Bootstrap/bootstrap-collapse.js',
        array('jquery'),
        false,
        true
    );
    ...
    wp_register_script(
        'script',
        '//mondial.palimg.com/wp-content/themes/petitmondial/js/script.js',
        array('jquery'),
        false,
        true
    );
    ...
    wp_register_script(
        'modal',
        '//mondial.palimg.com/wp-content/themes/petitmondial/js/vendor/Bootstrap/bootstrap-modal.js',
        array('jquery'),
        false,
        true
    );
...
if ( !is_nav_menu('Menu') ) {
    $menu_id1 = wp_create_nav_menu('Menu');
